...
All requests require a `type` parameter. Other parameters depend on the operation.

<ParamField query="type" type="string" required>
  Operation type: `decode`, `batch`, `wmi`, `makes`, `manufacturers`, `variables`, or `canadian`
</ParamField>
