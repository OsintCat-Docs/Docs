---
title: 'Minecraft OSINT'
api: 'GET https://www.osintcat.net/api/minecraft-osint'
---
...
```javascript Node.js
const url = 'https://www.osintcat.net/api/minecraft-osint?query=Notch&type=username&id=YOUR_API_KEY';
...
$url = "https://www.osintcat.net/api/minecraft-osint?query=Notch&type=username&id=YOUR_API_KEY";
...
func main() {
    baseURL := "https://www.osintcat.net/api/minecraft-osint"
    params := url.Values{}
...
uri = URI('https://www.osintcat.net/api/minecraft-osint')
params = { query: 'Notch', type: 'username', id: 'YOUR_API_KEY' }
...
public class OsintCatAPI {
    public static void main(String[] args) {
        try {
            String apiUrl = "https://www.osintcat.net/api/minecraft-osint?query=Notch&type=username&id=YOUR_API_KEY";
...
class Program
{
    static async Task Main(string[] args)
    {
        using (var client = new HttpClient())
        {
            try
            {
                string url = "https://www.osintcat.net/api/minecraft-osint?query=Notch&type=username&id=YOUR_API_KEY";
