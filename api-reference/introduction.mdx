...
All API endpoints require authentication using an API key. Include ur API key in the header as "x-api-key"
...
### Account Management
- **[User Info](/api-reference/endpoint/user)** - Get account information and usage statistics
